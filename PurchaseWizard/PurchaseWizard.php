...
namespace App\Wizards\PurchaseWizard;

use Arcanist\AbstractWizard;
use Arcanist\NullAction;
use Illuminate\Http\Request;

class PurchaseWizard extends AbstractWizard
{
    /**
     * The display name of this wizard.
     */
    public static string $title = 'PurchaseWizard';

    /**
     * The slug of this wizard that gets used in the URL.
     */
    public static string $slug = 'purchase-wizard';
